...
//        set.add(-9);
        ...
        System.out.println(actualData.equals(expectedData)); // для вывода true порядок expectedData и actualData должен быть одинаковым
        Set<Integer> actualSet = new HashSet<>(actualData);
        Set<Integer> expectedSet = new HashSet<>(expectedData);
        System.out.println(actualData.equals(expectedSet));
